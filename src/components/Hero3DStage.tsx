...
export function Hero3DStage() {
  ...
  return (
    <>
      <section className="relative min-h-screen overflow-hidden" style={{ backgroundColor: "#050d1f" }}>
        <Navbar />
        ...
        <div className="relative z-10 pt-28 flex flex-col">
          ...
          <div className="w-full flex justify-center px-6 mt-16">
            <div className="w-full max-w-4xl">
              ...
              >
                Прокачай свои навыки разведки по открытым источникам
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 }}
                className="mt-6 text-lg text-blue-300/70"
              >
                Реальные OSINT-задания для аналитиков и исследователей.
                <br />
                Находи улики, отслеживай следы, раскрывай истину.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <button className="text-blue-300/70 font-medium hover:text-white transition-colors flex items-center gap-2 text-sm">
                  <span className="text-blue-500/50">Новое:</span> CTF-турнир по OSINT
          ...
          >
            <div
              ...
              style={{
                background: "linear-gradient(to top, #050d1f 20%, transparent 100%)",
              }}
            />
